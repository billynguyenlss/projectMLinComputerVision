...
def test_regression(img_name):
    ...
    out1_true = cv2.imread(os.path.join(dir_path, "img/out1_true.jpg"), cv2.IMREAD_GRAYSCALE)
    out2_true = cv2.imread(os.path.join(dir_path, "img/out2_true.jpg"), cv2.IMREAD_GRAYSCALE)
    out3_true = cv2.imread(os.path.join(dir_path, "img/out3_true.jpg"), cv2.IMREAD_GRAYSCALE)
    ...
    output, out1, out2, out3 = demo.main(img)
